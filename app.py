...
#log_data = pd.read_csv("baby-a3c/pong-v4/log.txt")
...
#replays = h5py.File('duel_dqn_Pong-ram-v0_weights.h5f','r', driver='core')
...
def update_rewards_candlestick(start):
    ...
    for s in snapshots:
        ...
        #history = replays['model.'+str(s)+'.tar/history/0']
